...
scheduleSchema.methods.addCourse = function addCourse(courseNumber) {
...
scheduleSchema.methods.removeCourse = function removeCourse(courseNumber) {
  return new Promise((resolve, reject) => {
    if (courseNumber instanceof String) {
...
scheduleSchema.methods.saveToDB = function saveToDB() {
